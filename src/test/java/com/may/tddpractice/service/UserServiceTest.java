...
@ExtendWith(MockitoExtension.class) // 이 코드 없으면 NPE
class UserServiceTest {
    ...
    void mokitoTest() {
        ...
        // then
        assertThat(userList, is(findUserList));
    }
...
//    }
    ...
    @BeforeEach // BeforeAll : static 메서드로 선언해줘야 함
    void setup(){
